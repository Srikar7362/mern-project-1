                ...
                <Col lg='6' md='6'>
                    <div className="about__section-content">
                        ...
                        <h2 className="section__title">
                            Welcome to Rent Car Service Amravati
                        </h2>
                        <p className="section__description">
                            We are the very first company to provide the people of Amravati rent car for daily or hourly services. Rent car with very good condition in your range. cheap to expensive we have a lot of cars for your Service and you may choose any preferable car you want to ride!! inside of the city to outside of the city you can travel with our car by very simple condition and with very friendly budget!
                        </p>
